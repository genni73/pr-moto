...
export default function Login() {
  ...
  return (
    <div className="min-h-screen bg-dark flex items-center justify-center p-4">
      <div className="bg-dark-light rounded-2xl p-6 sm:p-8 w-full max-w-md border border-dark-lighter">
        <div className="text-center mb-8">
          <h1 className="text-3xl sm:text-4xl font-bold text-primary italic">P.R. MOTO</h1>
