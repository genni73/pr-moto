...
export default function Impostazioni() {
  ...
  return (
    <div>
      <h1 className="text-2xl sm:text-3xl font-bold mb-8">Impostazioni</h1>
      ...
      <div className="max-w-2xl space-y-8">
        ...
        <button onClick={handleSalva} className="flex items-center justify-center gap-2 w-full sm:w-auto px-6 py-3 bg-primary hover:bg-primary-dark text-white font-semibold rounded-lg transition-colors">
          <Save size={20} />
